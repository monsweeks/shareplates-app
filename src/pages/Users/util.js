...
function socialLogin(vendor, noImplementSite) {
  const redirectUri =
    window.location.port === '3000'
      ...
      : `http://mindplates.com:30000/oauth/${vendor}/token`;
  ...
  switch (vendor) {
    ...
    case 'naver': {
      window.location.href =
        'https://nid.naver.com/oauth2.0/authorize?client_id=FYKlwGmkoKaH8XSh3q6F&redirect_uri=http://mindplates.com:30000/oauth/naver/token&response_type=code';
      break;
    }

    case 'facebook': {
      window.location.href =
        'https://www.facebook.com/v3.2/dialog/oauth?client_id=212487773500466&redirect_uri=http://mindplates.com:30000/oauth/facebook/token&state=test&scope=email';
      break;
    }
